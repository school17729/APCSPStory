let music: HTMLAudioElement = new Audio("./resources/music.mp3");
music.loop = true;
window.addEventListener("click", () => {
    music.play();
});

let canvas: HTMLCanvasElement = document.querySelector(".effectsCanvas") as HTMLCanvasElement;
canvas.width = window.innerWidth;
canvas.height = window.innerHeight;
let ctx: CanvasRenderingContext2D = canvas.getContext("2d") as CanvasRenderingContext2D;
let headerSpan: HTMLSpanElement = document.querySelector(".headerSpan") as HTMLSpanElement;
let mainDiv: HTMLDivElement = document.querySelector(".mainDiv") as HTMLDivElement;
let pageDiv: HTMLDivElement = document.querySelector(".pageDiv") as HTMLDivElement;
let creditsDiv: HTMLDivElement = document.querySelector(".creditsDiv") as HTMLDivElement;
let pageSpan: HTMLSpanElement = document.querySelector(".pageSpan") as HTMLDivElement;
let navigatorDiv: HTMLDivElement = document.querySelector(".navigatorDiv") as HTMLDivElement;
let navigatorImg: HTMLImageElement = document.querySelector(".navigatorImg") as HTMLImageElement;
...
class Page {
    ...
    constructor(title: string, description: string, imageSrc: string) {
        this.title = title;
...
function handleClick(pageIndex: number): void {
